---
title: "Seven Layers of Memory"
date: 2026-04-14
author: Zesen Huang
tags: [tech]
lang: en
description: "How agent memory works as a gradient from ephemeral to infinite: conversation (disposable) → pad (always in context) → lingtai (identity) → codex (index in prompt, content on demand) → library (shared skill catalog) → network topology (collective memory) → the world."
---
