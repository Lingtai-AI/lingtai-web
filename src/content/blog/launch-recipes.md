---
title: "Launch Recipes: Portable Agent Culture"
date: 2026-04-10
tags: [tech]
lang: en
description: "Launch recipes package how an agent network behaves — greeting, constraints, and skills — into a portable directory. Share the culture of your network, not just the agents."
---
...
The skill covers directory structure, `recipe.json` format, placeholder contract, i18n rules, skill authoring, testing via `/setup`, and publishing via `/agora publish`. It's the recipe for making recipes.
...
The TUI bootstraps everything — Python runtime and dependencies are installed automatically on first launch. Create a network, let it run, then type `/agora publish` to share it with the world. Your recipe travels with it.
