...
const translations = {
  en: {
    nav: { logo: 'LingTai AI', home: 'Home', tutorial: 'Tutorial', blog: 'Blog', about: 'About', releases: 'Releases', opportunities: 'Opportunities', projects: 'Projects' },
    projects: {
      title: 'Projects',
  ...
  zh: {
    nav: { logo: '灵台AI', home: '首页', tutorial: '教程', blog: '博客', about: '关于', releases: '发布', opportunities: '机会', projects: '项目' },
    projects: {
      title: '项目',
      eyebrow: '基于灵台',
      hero: '生长在灵台之上的项目',
  ...
  wen: {
    nav: { logo: '灵台AI', home: '首页', tutorial: '启蒙', blog: '文录', about: '自述', releases: '纪', opportunities: '机缘', projects: '录' },
    projects: {
      title: '器灵录',
      eyebrow: '出自灵台',
      hero: '生于灵台之事',
