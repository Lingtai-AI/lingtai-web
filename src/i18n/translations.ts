...
const translations = {
  en: {
    nav: { logo: 'LingTai AI', home: 'Home', blog: 'Blog', about: 'About', agora: 'Agora', xingtan: 'Xingtan', releases: 'Releases', freeTokens: 'Free Tokens', opportunities: 'Opportunities' },
    hero: {
      title: 'LingTai',
      subtitle: 'Agent',
  ...
  zh: {
    nav: { logo: '灵台AI', home: '首页', blog: '博客', about: '关于', agora: '市集', xingtan: '杏坛', releases: '发布', freeTokens: '免费额度', opportunities: '机会' },
    agora: {
      title: 'Agent 市集',
      tagline: '数才市场(?)',
  ...
  wen: {
    nav: { logo: '灵台AI', home: '首页', blog: '文录', about: '自述', agora: '墟', xingtan: '杏坛', releases: '纪', freeTokens: '免额', opportunities: '机缘' },
    agora: {
      title: '器灵墟',
      tagline: '下山趁墟',
